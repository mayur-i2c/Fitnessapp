...
import { addEssentials, updateEssentials } from '../../ApiServices';
...
const EssentialsForm = () => {
  ...
  const onSubmit = (data) => {
    ...
    isupdate === ''
      ...
      : updateEssentials(formData, isupdate)
          .then(() => {
            localStorage.setItem('redirectSuccess', 'true');
    ...
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>
      ...
      <Grid item xs={12} md={6} lg={6}>
        <Grid container alignItems="center" justifyContent="space-between">
          <Grid item>
            <Typography variant="h5">{isupdate === '' ? 'Add' : 'Update'} Essential</Typography>
          </Grid>
          <Grid item />
        </Grid>
