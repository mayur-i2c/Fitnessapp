    ...
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>
      ...
      <Grid item xs={12} md={6} lg={6}>
        <Grid container alignItems="center" justifyContent="space-between">
          <Grid item>
            <Typography variant="h5">{isupdate === '' ? 'Add' : 'Update'} Faq</Typography>
          </Grid>
          <Grid item />
        </Grid>
                ...
                {defaultLoading ? (
                  ...
                  <div>
                    <CustomInput
                      ...
                      name="question"
                      label="Question"
                      inputRef={register('question', { required: true })}
                      error={!!errors.question}
                      helperText={errors.question && 'Question is required'} // Display the error message here
                    ...
                    <CustomInput
                      ...
                      name="answer"
                      label="Answer"
                      inputRef={register('answer', { required: true })}
                      error={!!errors.answer}
                      helperText={errors.answer && 'Answer is required'} // Display the error message here
                      placeholder="Answer"
