import { getAllNotification, deleteNotification, deleteMultNotification, sendNotification, updateNotiStatus } from '../../ApiServices';
              ...
              <Icons.Edit
                ...
                onClick={() => {
                  if (userRole == 1) {
                    ...
                    navigate('/settings/notifications/manage', { state: { editdata: editdata } });
                  } else {
                    toast.error(
          ...
          <div className="text-container">
            ...
            <div className="right-text">
              <Button
                ...
                onClick={() => {
                  if (userRole == 1) {
                    navigate('/settings/notifications/manage');
                  } else {
                    toast.error(
                      'Sorry, you do not have permission to access this feature.Please contact your administrator for assistance.'
                    );
