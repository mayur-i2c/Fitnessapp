import { getAllRecipeUnits, deleteRecipeUnit, deleteMultRecipeUnit, updateRecipeUnitsStatus } from '../../ApiServices';
...
const RecipeUnits = () => {
            ...
            <Switch
              ...
              onChange={() => {
                if (userRole == 1) {
                  ...
                  updateRecipeUnitsStatus(data, _id)
                    .then(() => {
              ...
              <Icons.Edit
                ...
                onClick={() => {
                  if (userRole == 1) {
                    ...
                    navigate('/settings/recipeUnits/manage', { state: { editdata: editdata } });
                  } else {
                    toast.error(
  ...
  const options = {
    customToolbarSelect: (selectedRows, data) => (
      <SelectedRowsToolbar selectedRows={selectedRows} data={data} columns={columns} datatableTitle="Recipe Unit" />
    )
  };
          ...
          <div className="text-container">
            ...
            <div className="right-text">
              <Button
                ...
                onClick={() => {
                  if (userRole == 1) {
                    navigate('/settings/recipeUnits/manage');
                  } else {
                    toast.error(
                      'Sorry, you do not have permission to access this feature.Please contact your administrator for assistance.'
                    );
